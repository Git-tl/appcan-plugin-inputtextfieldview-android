...
public class PageIndicator extends LinearLayout {
	...
	public void setCurrentPage(int index) {
		for (int i = 0, size = getChildCount(); i < size; i++) {
			...
			if (i == index) {
				view.setBackgroundResource(EUExUtil.getResDrawableID("plugin_input_pages_pointer_focus"));
			} else {
				view.setBackgroundResource(EUExUtil.getResDrawableID("plugin_input_pages_pointer_normal"));
			}
		}
	}
